-- Complete reinitialization of menu items with correct image paths
-- This will delete all existing menu items and recreate them
...
SELECT id, name, image FROM menu_items ORDER BY category_id, sort_order;
