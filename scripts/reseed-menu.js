...
db.serialize(() => {
  ...
  db.run('DELETE FROM sqlite_sequence WHERE name IN ("menu_items", "menu_categories")', (err) => {
    if (err && !err.message.includes('no such table')) {
      console.error('⚠️  Warning resetting sequence:', err.message);
    }
  });
  
  console.log('\n📦 Seeding new Hebrew menu data...\n');
