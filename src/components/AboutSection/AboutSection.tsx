        ...
        <article className="about-block">
          <div className="about-content">
            <div className="about-text">
              ...
              <p className="about-description">
                בנטורליי מרענן, אנחנו מציעים מגוון מלא של מוצרי פירות טריים: מיצים טבעיים טריים - מוכנים מדי יום מהפירות והירקות הטובים ביותר, סמוזי טעימים - שילובים קרמיים ומרעננים עמוסים בוויטמינים, סלטי פירות צבעוניים - פירות עונתיים טריים חתוכים ומוכנים לפי הזמנה, צלחות בריאות - ארוחות מזינות מלאות עם פירות, ירקות ועוד, ומוצרי פירות טריים - פירות באיכות פרימיום מוכנים לקחת הביתה.
              </p>
              <p className="about-description">
