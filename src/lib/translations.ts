...
const hebrewTranslations: Record<string, string> = {
  ...
  'addon': 'תוספת',
  'ingredients': 'מרכיבים',
  'addons management': 'ניהול תוספות',
  'manage product boosts and extras': 'נהל תוספות ושיפורים למוצרים',
  'total addons': 'סה"כ תוספות',
  'all addons': 'כל התוספות',
  'manage product addons and boosts': 'נהל תוספות ושיפורים למוצרים',
  'add addon': 'הוסף תוספת',
  'no addons yet': 'אין עדיין תוספות',
  'edit addon': 'ערוך תוספת',
  'new addon': 'תוספת חדשה',
  'update addon information': 'עדכן מידע תוספת',
  'create a new addon': 'צור תוספת חדשה',
  'addon name is required.': 'שם תוספת נדרש',
  'addon updated successfully.': 'תוספת עודכנה בהצלחה',
  'addon created successfully.': 'תוספת נוצרה בהצלחה',
  'addon deleted successfully.': 'תוספת נמחקה בהצלחה',
  'delete addon': 'מחק תוספת',
  'are you sure you want to delete this addon? this action cannot be undone.': 'האם אתה בטוח שברצונך למחוק תוספת זו? פעולה זו לא ניתנת לביטול',
  'failed to delete addon.': 'נכשל במחיקת תוספת',
  'error saving addon.': 'שגיאה בשמירת תוספת',
  'an error occurred while saving the addon.': 'אירעה שגיאה בעת שמירת התוספת',
  'an error occurred while deleting the addon.': 'אירעה שגיאה בעת מחיקת התוספת',
  'loading addons...': 'טוען תוספות...',
  'addon description (optional)': 'תיאור תוספת (אופציונלי)',
  'protein powder': 'אבקת חלבון',
  'boost your drink': 'שפר את המשקה שלך',
  'fruits': 'פירות',
  'boosters': 'בוסטרים',
  'toppings': 'תוספות',
  'volume': 'נפח',
  ...
  'Fresh Made': 'טרי ומוכן',
  'Select Size': 'בחר גודל',
  'Additional Options': 'אפשרויות נוספות',
  'Add to Cart': 'הוסף לעגלה',
  'Must select': 'חובה לבחור',
  'Popular': 'פופולרי',
  'Close': 'סגור',
  'loading details...': 'טוען פרטים...',
  'Natural ingredients experience.': 'חוויה של מרכיבים טבעיים.',
  'Total': 'סה"כ',
  'small': 'קטן',
  'medium': 'בינוני',
  'large': 'גדול',
  ...
  'try again': 'נסה שוב',
  'please select at least one ingredient from required groups': 'אנא בחר לפחות מרכיב אחד מקבוצות חובה',
  ...
  'show "view on map" button': 'הצג כפתור "צפה במפה"',
  ...
  'no products available in this prompt.': 'אין מוצרים זמינים בהנחיה זו.',
  ...
  'correction:': 'תיקון:',
  'request correction of inaccurate or incomplete information': 'בקש תיקון של מידע לא מדויק או לא מלא',
  'deletion:': 'מחיקה:',
