...
const hebrewTranslations: Record<string, string> = {
  ...
  'Our Commitment to Accessibility': 'המחויבות שלנו לנגישות',
  'REVIVA is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying the relevant accessibility standards.': 'ראביבה מחויבת להבטיח נגישות דיגיטלית לאנשים עם מוגבלויות. אנו משפרים ללא הרף את חוויית המשתמש לכולם ומיישמים את תקני הנגישות הרלוונטיים.',
  'Conformance Status': 'סטטוס התאמה',
  'The Web Content Accessibility Guidelines (WCAG) defines requirements for designers and developers to improve accessibility for people with disabilities. It defines three levels of conformance: Level A, Level AA, and Level AAA. This website is partially conformant with WCAG 2.1 level AA.': 'הנחיות נגישות תוכן אינטרנט (WCAG) מגדירות דרישות למעצבים ומפתחים לשיפור נגישות לאנשים עם מוגבלויות. הן מגדירות שלוש רמות התאמה: רמה A, רמה AA ורמה AAA. אתר זה תואם חלקית ל-WCAG 2.1 רמה AA.',
  'Partially conformant means that some parts of the content do not fully conform to the accessibility standard.': 'התאמה חלקית פירושה שחלקים מסוימים של התוכן אינם תואמים באופן מלא לתקן הנגישות.',
  'Accessibility Features': 'תכונות נגישות',
  'Our website includes the following accessibility features:': 'האתר שלנו כולל את תכונות הנגישות הבאות:',
  'Keyboard Navigation:': 'ניווט במקלדת:',
  'All interactive elements can be accessed using keyboard': 'כל האלמנטים האינטראקטיביים נגישים באמצעות מקלדת',
  'Screen Reader Support:': 'תמיכה בקורא מסך:',
  'Proper semantic HTML and ARIA labels for assistive technologies': 'HTML סמנטי נכון ותוויות ARIA עבור טכנולוגיות מסייעות',
  'Text Alternatives:': 'חלופות טקסט:',
  'Alternative text for images and non-text content': 'טקסט חלופי לתמונות ותוכן שאינו טקסט',
  'Color Contrast:': 'ניגודיות צבעים:',
  'Sufficient color contrast ratios for readability': 'יחסי ניגודיות צבעים מספקים לקריאות',
  'Resizable Text:': 'טקסט שניתן לשינוי גודל:',
  'Text can be resized up to 200% without loss of functionality': 'ניתן לשנות את גודל הטקסט עד 200% ללא אובדן פונקציונליות',
  'Focus Indicators:': 'מחווני פוקוס:',
  'Visible focus indicators for keyboard navigation': 'מחווני פוקוס גלויים לניווט במקלדת',
  'Accessible Forms:': 'טפסים נגישים:',
  'Properly labeled form fields with error identification': 'שדות טופס מסומנים כראוי עם זיהוי שגיאות',
  'Skip Navigation:': 'דילוג על ניווט:',
  'Skip to main content links for screen reader users': 'קישורי דילוג לתוכן הראשי למשתמשי קורא מסך',
  'Assistive Technologies': 'טכנולוגיות מסייעות',
  'This website is designed to be compatible with the following assistive technologies:': 'אתר זה מיועד להיות תואם לטכנולוגיות המסייעות הבאות:',
  'Screen readers (NVDA, JAWS, VoiceOver)': 'קוראי מסך (NVDA, JAWS, VoiceOver)',
  'Screen magnification software': 'תוכנת הגדלת מסך',
  'Speech recognition software': 'תוכנת זיהוי דיבור',
  'Keyboard-only navigation': 'ניווט במקלדת בלבד',
  'Alternative input devices': 'התקני קלט חלופיים',
  'Known Limitations': 'מגבלות ידועות',
  'Despite our best efforts to ensure accessibility, there may be some limitations. Below are known issues:': 'למרות המאמצים הטובים ביותר שלנו להבטיח נגישות, ייתכנו מגבלות מסוימות. להלן בעיות ידועות:',
  'Some third-party content may not be fully accessible': 'תוכן צד שלישי מסוים עשוי שלא להיות נגיש באופן מלא',
  'Older PDF documents may not meet current accessibility standards': 'מסמכי PDF ישנים יותר עשויים שלא לעמוד בתקני הנגישות הנוכחיים',
  'Some embedded videos may lack captions or transcripts': 'חלק מהסרטונים המוטמעים עשויים להיות חסרי כתוביות או תמלילים',
  'We are working to address these issues and improve accessibility across our entire website.': 'אנו עובדים לטפל בבעיות אלו ולשפר את הנגישות בכל האתר שלנו.',
  'Technical Specifications': 'מפרטים טכניים',
  'Accessibility of this website relies on the following technologies:': 'נגישות של אתר זה מסתמכת על הטכנולוגיות הבאות:',
  'These technologies are relied upon for conformance with the accessibility standards used.': 'טכנולוגיות אלו נדרשות להתאמה לתקני הנגישות המשמשים.',
  'Testing and Evaluation': 'בדיקה והערכה',
  'Our website has been tested using the following methods:': 'האתר שלנו נבדק באמצעות השיטות הבאות:',
  'Automated accessibility testing tools': 'כלי בדיקת נגישות אוטומטיים',
  'Manual testing with keyboard navigation': 'בדיקה ידנית עם ניווט במקלדת',
  'Screen reader testing': 'בדיקת קורא מסך',
  'Color contrast analysis': 'ניתוח ניגודיות צבעים',
  'User testing with people with disabilities': 'בדיקות משתמשים עם אנשים עם מוגבלויות',
  'Accessibility Tools': 'כלי נגישות',
  'We provide an accessibility widget on our website that allows you to:': 'אנו מספקים ווידג\'ט נגישות באתר שלנו המאפשר לך:',
  'Adjust text size': 'להתאים גודל טקסט',
  'Increase contrast': 'להגביר ניגודיות',
  'Enable text-to-speech': 'להפעיל המרת טקסט לדיבור',
  'Highlight links': 'להדגיש קישורים',
  'Use a reading guide': 'להשתמש במדריך קריאה',
  'Adjust letter and line spacing': 'להתאים ריווח אותיות ושורות',
  'Feedback and Complaints': 'משוב ותלונות',
  'We welcome your feedback on the accessibility of this website. If you encounter any accessibility barriers, please let us know:': 'אנו מזמינים את המשוב שלך על נגישות האתר הזה. אם אתה נתקל במחסומי נגישות כלשהם, אנא הודע לנו:',
  'We aim to respond to accessibility feedback within 5 business days and to propose a solution within 10 business days.': 'אנו שואפים להגיב למשוב נגישות תוך 5 ימי עסקים ולהציע פתרון תוך 10 ימי עסקים.',
  'Ongoing Efforts': 'מאמצים מתמשכים',
  'We are committed to continuous improvement of our website accessibility:': 'אנו מחויבים לשיפור מתמיד של נגישות האתר שלנו:',
  'Regular accessibility audits and testing': 'ביקורות ובדיקות נגישות קבועות',
  'Staff training on accessibility best practices': 'הדרכת צוות על שיטות עבודה מומלצות לנגישות',
  'Including accessibility in our design and development process': 'הכללת נגישות בתהליך העיצוב והפיתוח שלנו',
  'Monitoring and updating accessibility features': 'ניטור ועדכון תכונות נגישות',
  'Engaging with the disability community for feedback': 'מעורבות עם קהילת בעלי המוגבלויות למשוב',
  'Legal Requirements': 'דרישות משפטיות',
  'This accessibility statement is in accordance with the Israeli Equal Rights for Persons with Disabilities Regulations (Accessibility Adjustments to Service), 5773-2013, and the Web Content Accessibility Guidelines (WCAG) 2.1.': 'הצהרת נגישות זו היא בהתאם לתקנות הישראליות לשוויון זכויות לאנשים עם מוגבלויות (התאמות נגישות לשירות), התשע"ג-2013, ולהנחיות נגישות תוכן אינטרנט (WCAG) 2.1.',
  'Date of Statement': 'תאריך ההצהרה',
  'This accessibility statement was created on': 'הצהרת נגישות זו נוצרה בתאריך',
  'and last reviewed on the same date.': 'ונבדקה לאחרונה באותו תאריך.',
  'Contact Information': 'פרטי יצירת קשר',
  'If you have questions or need assistance with accessibility, please contact us:': 'אם יש לך שאלות או שאתה זקוק לסיוע בנגישות, אנא צור איתנו קשר:',
