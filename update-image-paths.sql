-- Update image paths from Hebrew to English names
-- Run this after renaming the files
...
-- Salads
UPDATE menu_items SET image = '/uploads/menu/salad-fruits-large.jpg' WHERE image = '/uploads/menu/קערה גדולה  של פרות העונה +רימון.jpg';
UPDATE menu_items SET image = '/uploads/menu/salad-fruits-medium.jpg' WHERE image = '/uploads/menu/קערה בינונית של פרות העונה +רימון.jpg';
...
-- Special packages
UPDATE menu_items SET image = '/uploads/menu/package-cola-gummies.jpg' WHERE image = '/uploads/menu/6 קולה_ זירו + גומיות.jpg';
UPDATE menu_items SET image = '/uploads/menu/package-cola-nuts.jpg' WHERE image = '/uploads/menu/6 קולה_ זירו + פיצוחים.jpg';
UPDATE menu_items SET image = '/uploads/menu/package-cola-snacks.jpg' WHERE image = '/uploads/menu/6קולה_ זירו + עשר 6 חטיפים שונים.jpg';
UPDATE menu_items SET image = '/uploads/menu/package-arak-excel-gummies.jpg' WHERE image = '/uploads/menu/ערק + 6 אקסלים + גומי.jpg';
UPDATE menu_items SET image = '/uploads/menu/package-arak-excel-malabi.jpg' WHERE image = '/uploads/menu/ערק + 6 אקסלים + 6 מלבי.jpg';
UPDATE menu_items SET image = '/uploads/menu/package-arak-excel-nuts.jpg' WHERE image = '/uploads/menu/ערק + 6 אקסלים + מגש פיצוחים.jpg';
UPDATE menu_items SET image = '/uploads/menu/package-arak-excel-fruits.jpg' WHERE image = '/uploads/menu/ערק + 6 אקסלים + מגש פירות בינוני.jpg';

-- Romantic packages
UPDATE menu_items SET image = '/uploads/menu/wine-white-gummies.jpg' WHERE image = '/uploads/menu/יין לבן + מארז גומיות.jpg';
UPDATE menu_items SET image = '/uploads/menu/romantic-indulgent.jpg' WHERE image = '/uploads/menu/טבעי שזה מפנק.jpg';
UPDATE menu_items SET image = '/uploads/menu/romantic-couples.jpg' WHERE image = '/uploads/menu/טבעי שזה זוגי.jpg';
UPDATE menu_items SET image = '/uploads/menu/romantic-wink.jpg' WHERE image = '/uploads/menu/טבעי שזה קורץ.jpg';
UPDATE menu_items SET image = '/uploads/menu/romantic-generous.jpg' WHERE image = '/uploads/menu/טבעי שזה מפרגן.jpg';
UPDATE menu_items SET image = '/uploads/menu/romantic-pleasant.jpg' WHERE image = '/uploads/menu/טבעי שזה נעים.jpg';
UPDATE menu_items SET image = '/uploads/menu/romantic-warm.jpg' WHERE image = '/uploads/menu/טבעי שזה חמים.jpg';
UPDATE menu_items SET image = '/uploads/menu/romantic-luxury.jpg' WHERE image = '/uploads/menu/טבעי שזה של הביוקר.jpg';
...
UPDATE menu_items SET image = '/uploads/menu/dessert-tasty.jpg' WHERE image = '/uploads/menu/טבעי שזה טעים (קינוחים).jpg';
UPDATE menu_items SET image = '/uploads/menu/dessert-healthy.jpg' WHERE image = '/uploads/menu/טבעי שזה בריא (קינוחים).jpg';
